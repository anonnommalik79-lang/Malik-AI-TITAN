  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/90 p-4 backdrop-blur-2xl">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] border border-violet-300/20 bg-[#05070f] p-8 text-white shadow-[0_40px_120px_rgba(88,28,135,.35)]">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_0%,rgba(217, 174, 69,.22),transparent_45%),radial-gradient(circle_at_80%_80%,rgba(228, 187, 94,.12),transparent_40%)]" />
        <div className="relative">
          ...
          <div className="mt-6 flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-cyan-400 text-black shadow-[0_0_50px_rgba(217, 174, 69,.4)]">
