...
export function BusinessModelSelector({
  ...
  return (
    <div className={`bm-select${open ? " is-open" : ""}`}>
      <button
        type="button"
      ...
      <style jsx global>{`
        ...
        .bm-menu{position:absolute;top:89px;left:4px;width:calc(100% + 76px);min-width:430px;max-width:504px;border:1px solid #3e4147;border-radius:17px;background:#15171a;padding:13px;box-shadow:0 24px 70px rgba(0,0,0,.56);overflow:hidden}
        ...
        @media(max-width:700px){.bm-select{width:100%}.bm-trigger{height:68px;grid-template-columns:42px minmax(0,1fr) 24px;border-radius:15px;padding:0 14px}.bm-trigger-copy strong{font-size:15px}.bm-trigger-copy small{font-size:11px}.bm-menu{left:0;top:78px;width:100%;min-width:0;max-width:none;padding:9px}.bm-option{height:54px;grid-template-columns:42px minmax(0,1fr) 24px;padding:0 10px}.bm-option-label{font-size:14px}.bm-provider{width:34px;height:34px}}
      `}</style>
    </div>
  )
}
