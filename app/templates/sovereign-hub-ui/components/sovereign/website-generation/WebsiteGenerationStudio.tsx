...
function spriteImageStyle(index: number): CSSProperties {
...
function TemplatePreview({ template }: { template: Template }) {
  return (
    <span className="spriteViewport" aria-hidden="true">
      <img className="spriteImage" src={SPRITE} alt="" draggable={false} style={spriteImageStyle(template.index)} />
    </span>
  )
}
