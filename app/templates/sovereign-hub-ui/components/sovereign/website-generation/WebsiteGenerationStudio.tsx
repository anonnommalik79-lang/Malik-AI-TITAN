          ...
          {shown.map((template, position) => (
            ...
            <article className="templateCard" key={template.id}>
              <button
                ...
                aria-label={`Посмотреть ${template.title} крупно`}
              >
