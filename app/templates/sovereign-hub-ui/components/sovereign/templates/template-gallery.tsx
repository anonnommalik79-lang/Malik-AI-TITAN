...
<head>
  ...
  <style>
    ...
    .shell { min-height: 100vh; overflow: hidden; background:
      radial-gradient(circle at 16% 8%, rgba(34,211,238,.26), transparent 28%),
      radial-gradient(circle at 84% 12%, rgba(168,85,247,.24), transparent 30%),
    ...
    .eyebrow { color: ${tone === "amber" ? "#fde68a" : tone === "emerald" ? "#a7f3d0" : tone === "rose" ? "#fecdd3" : "#a5f3fc"}; font-size: 12px; font-weight: 900; letter-spacing: .22em; text-transform: uppercase; }
    ...
    .tags span { border: 1px solid rgba(255,255,255,.12); border-radius: 999px; background: rgba(255,255,255,.06); padding: 8px 12px; color: rgba(207,250,254,.92); font-size: 12px; font-weight: 800; }
    ...
    .workflow b { color: rgba(125,211,252,.95); }
...
export function TemplateGalleryPanel({ onSendToCanvas, onUseTemplate }: TemplateGalleryPanelProps) {
  ...
  return (
    <section className="titan-template-shell">
      <PremiumCss />
      <style>{`
        .titan-template-shell{position:relative;display:flex;height:100%;min-height:0;flex-direction:column;overflow:hidden;border:1px solid rgba(255,255,255,.10);border-radius:2rem;background:radial-gradient(circle at 12% 0%,rgba(34,211,238,.16),transparent 28%),radial-gradient(circle at 88% 10%,rgba(168,85,247,.18),transparent 30%),linear-gradient(180deg,rgba(3,7,18,.96),rgba(2,3,8,.98));box-shadow:0 40px 160px rgba(0,0,0,.45);color:white}
        ...
        .titan-search{min-height:3.25rem;border:1px solid rgba(125,211,252,.18);border-radius:1.25rem;background:rgba(0,0,0,.35);display:flex;align-items:center;gap:.75rem;padding:0 1rem;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}
        .titan-search svg{height:1.1rem;width:1.1rem;color:rgba(165,243,252,.9)}
        ...
        .titan-filter-board{margin-top:1rem;display:flex;gap:.65rem;overflow-x:auto;padding-bottom:.2rem;scrollbar-width:none}.titan-filter-board::-webkit-scrollbar{display:none}.titan-filter-board button{flex:0 0 auto;border:1px solid rgba(255,255,255,.10);border-radius:999px;background:rgba(255,255,255,.04);padding:.72rem 1rem;color:rgba(226,232,240,.82);font-size:.75rem;font-weight:900;transition:.18s}.titan-filter-board button:hover,.titan-filter-board button.is-active{border-color:rgba(125,211,252,.35);background:rgba(34,211,238,.10);color:white;box-shadow:0 0 40px rgba(34,211,238,.10)}
        ...
        .titan-status-line{margin-top:.85rem;display:flex;align-items:center;justify-content:space-between;gap:1rem;color:rgba(186,230,253,.86);font-size:.82rem;font-weight:800}.titan-status-line button{border:1px solid rgba(255,255,255,.12);border-radius:1rem;background:white;color:#020308;padding:.72rem 1rem;font-weight:1000;display:flex;gap:.45rem;align-items:center}
        .titan-template-body{position:relative;z-index:1;min-height:0;flex:1;overflow-y:auto;padding:1.25rem;scrollbar-width:thin;scrollbar-color:rgba(125,211,252,.3) transparent}.titan-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}
        .titan-template-card{position:relative;overflow:hidden;border:1px solid rgba(255,255,255,.10);border-radius:2rem;background:rgba(255,255,255,.045);box-shadow:0 26px 90px rgba(0,0,0,.28);backdrop-filter:blur(20px);transition:transform .22s ease,border-color .22s ease,background .22s ease}.titan-template-card:hover{transform:translateY(-4px);border-color:rgba(125,211,252,.28);background:rgba(255,255,255,.065)}.titan-template-card:before{content:"";position:absolute;inset:-40% -20% auto;height:55%;background:radial-gradient(circle,rgba(125,211,252,.20),transparent 60%);opacity:.75;pointer-events:none}.titan-template-card[data-tone="violet"]:before{background:radial-gradient(circle,rgba(168,85,247,.22),transparent 60%)}.titan-template-card[data-tone="amber"]:before{background:radial-gradient(circle,rgba(251,191,36,.20),transparent 60%)}.titan-template-card[data-tone="emerald"]:before{background:radial-gradient(circle,rgba(52,211,153,.20),transparent 60%)}.titan-template-card[data-tone="rose"]:before{background:radial-gradient(circle,rgba(244,63,94,.18),transparent 60%)}
        ...
        .titan-template-visual{position:relative;padding:.7rem .7rem 0}.titan-template-visual>div:first-child{border-radius:1.5rem;overflow:hidden}.titan-template-visual-hud{position:absolute;right:1.25rem;bottom:.7rem;display:flex;gap:.35rem}.titan-template-visual-hud span{width:.5rem;height:.5rem;border-radius:999px;background:rgba(125,211,252,.85);box-shadow:0 0 16px rgba(34,211,238,.5)}.titan-card-body{position:relative;z-index:2;padding:1rem}.titan-title-row{display:flex;align-items:center;gap:.75rem}.titan-title-row p{font-size:.68rem;font-weight:1000;letter-spacing:.18em;text-transform:uppercase;color:rgba(125,211,252,.82)}.titan-title-row h3{margin-top:.2rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:1.08rem;font-weight:1000;letter-spacing:-.02em}.titan-card-icon{display:grid;place-items:center;width:2.35rem;height:2.35rem;border:1px solid rgba(255,255,255,.12);border-radius:.95rem;background:rgba(255,255,255,.06)}.titan-card-description{min-height:4.6rem;margin-top:.85rem;color:rgba(203,213,225,.76);font-size:.85rem;line-height:1.65}.titan-score-row{margin-top:.95rem;border:1px solid rgba(255,255,255,.10);border-radius:1.25rem;background:rgba(0,0,0,.22);padding:.85rem}.titan-score-row>div:first-child{display:flex;justify-content:space-between;color:rgba(148,163,184,.88);font-size:.72rem;font-weight:900}.titan-score-row strong{color:white}.titan-score-bar{margin-top:.6rem;height:.42rem;border-radius:999px;background:rgba(255,255,255,.08);overflow:hidden}.titan-score-bar i{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#67e8f9,#a78bfa,#f0abfc)}
