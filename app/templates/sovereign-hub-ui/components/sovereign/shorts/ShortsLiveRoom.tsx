...
export function ShortsLiveRoom({ liveId }: { liveId: string }) {
  ...
  if (!session) return <div style={page}><div style={inner}><Link href="/shorts" style={back}><ArrowLeft size={14} /> Malik Live</Link><div className={styles.empty}>Эфир не найден или уже недоступен.</div></div></div>
