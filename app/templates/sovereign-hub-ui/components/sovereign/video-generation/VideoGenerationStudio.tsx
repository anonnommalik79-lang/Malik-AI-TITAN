...
function MalikMediaWatermark({ compact = false }: { compact?: boolean }) {
  return (
    <div className={`malik-media-watermark${compact ? " is-compact" : ""}`} aria-label="Malik AI">
      <svg viewBox="0 0 100 58" aria-hidden="true" focusable="false">
        <path d="M4 53 46 11v42H4Z" fill="currentColor" />
        <path d="M55 11h41L55 53V11Z" fill="currentColor" />
      </svg>
      <span>Malik AI</span>
    </div>
  )
  ...
  return (
    <main className="mv2" data-view="video-generation-v2" data-phase={phase}>
      ...
      <style jsx>{`
        ...
        .mv2__stage{position:relative;aspect-ratio:16/10.4;overflow:hidden;background:#06080c}.mv2__result-frame{position:relative;width:100%;height:100%;display:grid;place-items:center;overflow:hidden;background:#050608}.mv2__media{position:absolute;inset:0;display:grid;place-items:center;background:#050608}.mv2__hero-video,.mv2__result,.mv2__source-image,.mv2__source-video{width:100%;height:100%;display:block;background:#050608}.malik-media-watermark{position:absolute;z-index:8;right:22px;bottom:18px;width:88px;display:flex;flex-direction:column;align-items:center;gap:4px;pointer-events:none;user-select:none;opacity:.82;color:#fff;filter:drop-shadow(0 2px 4px rgba(0,0,0,.82))}.malik-media-watermark svg{display:block;width:62px;height:auto;color:#fff}.malik-media-watermark span{color:#fff;font-size:13px;font-weight:650;line-height:1;letter-spacing:.01em;text-shadow:0 1px 3px rgba(0,0,0,.92)}.malik-media-watermark.is-compact{right:12px;bottom:10px;width:68px;gap:3px;opacity:.86}.malik-media-watermark.is-compact svg{width:48px}.malik-media-watermark.is-compact span{font-size:10px}.mv2__source-image,.mv2__source-video{object-fit:contain!important;object-position:center center!important;transform:none!important;max-width:100%!important;max-height:100%!important}.mv2__hero-video,.mv2__result{object-fit:contain}.mv2__stage:after{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(180deg,rgba(0,0,0,.18),transparent 22%,transparent 70%,rgba(0,0,0,.36))}
