...
assert.match(router, /runHiddenGeminiMultimodal/, "router hardening must preserve hidden multimodal support")
...
assert.match(stream, /prepareMalikAgentRuntime\(executionBody\)/, "agent runtime must receive attachment-enriched context")
