...
const scheduleIntent = read("lib/ai/schedule-intent.ts")
const streamRoute = read("app/api/stream/route-impl.ts")
...
assert.match(scheduledStore, /MALIK_SCHEDULER_ACTIVE/)
assert.match(scheduledStore, /runnerConfigured/)
...
assert.match(scheduleIntent, /explicitAutomation/)
assert.match(scheduleIntent, /kind: "once"/)
assert.match(scheduleIntent, /kind: "interval"/)
assert.match(scheduleIntent, /kind: "daily"/)
assert.match(scheduleIntent, /kind: "weekly"/)
assert.match(streamRoute, /scheduledCommandAnswer/)
assert.match(streamRoute, /detectScheduleIntent/)
assert.match(streamRoute, /MALIK_MAX_TEXT_CONTEXT_CHARS/)
